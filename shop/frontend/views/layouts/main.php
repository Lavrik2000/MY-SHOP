                                    ...
                                    <tr>
                                        <td class="text-center"><a
                                                    href="/index.php?route=product/product&amp;product_id=30"><img
                                                        src="http://static.inet-shop.ru/cache/products/canon_eos_5d_1-74x74.jpg"
                                    ...
                                    <tr>
                                        <td class="text-center"><a
                                                    href="/index.php?route=product/product&amp;product_id=40"><img
                                                        src="http://static.inet-shop.ru/cache/products/iphone_1-74x74.jpg"
            ...
            <div id="content" class="col-sm-12">
                <div id="slideshow0" class="owl-carousel" style="opacity: 1;">
                    <div class="item">
                        <a href="index.php?route=product/product&amp;path=57&amp;product_id=49"><img
                                    src="http://static.inet-shop.ru/cache/banners/iPhone6-1140x380.jpg"
                                    alt="iPhone 6" class="img-responsive"/></a>
                    </div>
                    <div class="item">
                        <img src="http://static.inet-shop.ru/cache/banners/MacBookAir-1140x380.jpg"
                ...
                <div class="row">
                        ...
                        <div class="product-thumb transition">
                            <div class="image"><a
                                        href="/index.php?route=product/product&amp;product_id=43"><img
                                            src="http://static.inet-shop.ru/cache/products/macbook_1-200x200.jpg"
                    ...
                    <div class="product-layout col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product-thumb transition">
                            <div class="image"><a
                                        href="/index.php?route=product/product&amp;product_id=40"><img
                                            src="http://static.inet-shop.ru/cache/products/iphone_1-200x200.jpg"
                        ...
                        <div class="product-thumb transition">
                            <div class="image"><a
                                        href="/index.php?route=product/product&amp;product_id=42"><img
                                            src="http://static.inet-shop.ru/cache/products/apple_cinema_30-200x200.jpg"
                    ...
                    <div class="product-layout col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="product-thumb transition">
                            <div class="image"><a
                                        href="/index.php?route=product/product&amp;product_id=30"><img
                                            src="http://static.inet-shop.ru/cache/products/canon_eos_5d_1-200x200.jpg"
                ...
                <div id="carousel0" class="owl-carousel">
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/nfl-130x100.png" alt="NFL"
                             class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/redbull-130x100.png"
                             alt="RedBull" class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/sony-130x100.png" alt="Sony"
                             class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/cocacola-130x100.png"
                             alt="Coca Cola" class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/burgerking-130x100.png"
                             alt="Burger King" class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/canon-130x100.png" alt="Canon"
                             class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/harley-130x100.png"
                             alt="Harley Davidson" class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/dell-130x100.png" alt="Dell"
                             class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/disney-130x100.png"
                             alt="Disney" class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/starbucks-130x100.png"
                             alt="Starbucks" class="img-responsive"/>
                    </div>
                    <div class="item text-center">
                        <img src="http://static.inet-shop.ru/cache/manufacturer/nintendo-130x100.png"
